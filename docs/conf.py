...
texinfo_documents = [
    (master_doc, 'simple-salesforce-2-7', 'simple-salesforce-2-7 Documentation',
     author, 'simple-salesforce-2-7', 'One line description of project.',
     'Miscellaneous'),
]
